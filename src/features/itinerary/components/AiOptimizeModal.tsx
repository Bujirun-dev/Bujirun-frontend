...
export function AiOptimizeModal({ isOpen, onClose, onConfirm }: AiOptimizeModalProps) {
  return (
    <Modal
      isOpen={isOpen}
      onClose={onClose}
      icon={<Image src={magicWandIcon} alt="AI 최적화" width={28} height={28} className="icon-deepblue" />}
      title="AI 일정 최적화"
    ...
    >
      <div className="flex flex-col items-center w-full">
        <div className="flex flex-col items-start gap-0.5">
          <p className="flex items-center gap-1.5 text-sm font-medium text-sub-darkgray leading-none">
