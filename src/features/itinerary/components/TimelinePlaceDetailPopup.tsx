        ...
        <div className="flex h-[470px] w-full flex-col overflow-hidden rounded-3xl border-[0.5px] border-system-glassborder bg-main-white px-4 py-5 shadow-[2px_2px_10px_0px_var(--color-system-glassborder)]">
          <div className="mb-1.5 flex items-center justify-between">
            ...
            >
              <Image
                ...
                width={12}
                height={12}
                className="brightness-0 saturate-0 opacity-55"
                aria-hidden
              />
            </button>
            <button
          ...
          <div className="relative h-[145px] w-full shrink-0 overflow-hidden rounded-[10px]">
            ...
            <div className="absolute right-1 top-2">
              <StatusBadge status={bookmarked ? "collected" : "uncollected"} />
            </div>
          </div>
          ...
          <div className="flex shrink-0 items-center border-b-[0.3px] border-sub-lightgray pb-2.5 pt-3">
            <div className="flex min-w-0 items-center">
              <MarkerIcon
                width={12}
                height={12}
                className="mr-1 shrink-0 fill-sub-pink"
                aria-hidden
              />
              <h2 className="mr-3 truncate text-md font-medium text-text-heading">
                {stop.placeName}
              </h2>
