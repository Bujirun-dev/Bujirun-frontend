...
export function AvatarSelectModal({
  ...
  return createPortal(
    ...
    >
      <div
        className="w-full max-w-[320px] max-h-[80dvh] overflow-y-auto overflow-x-hidden bg-white rounded-3xl px-5 py-6 flex flex-col gap-5"
        onClick={(e) => e.stopPropagation()}
      >
        <h3 className="font-bold text-lg text-text-heading text-center">프로필 사진 선택</h3>
