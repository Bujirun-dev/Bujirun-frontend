...
export const paperlogy = localFont({
  src: [
    { path: "../assets/fonts/Paperlogy-1Thin.woff2", weight: "100", style: "normal" },
    { path: "../assets/fonts/Paperlogy-2ExtraLight.woff2", weight: "200", style: "normal" },
    { path: "../assets/fonts/Paperlogy-3Light.woff2", weight: "300", style: "normal" },
    ...
    { path: "../assets/fonts/Paperlogy-8ExtraBold.woff2", weight: "800", style: "normal" },
    { path: "../assets/fonts/Paperlogy-9Black.woff2", weight: "900", style: "normal" },
  ],
