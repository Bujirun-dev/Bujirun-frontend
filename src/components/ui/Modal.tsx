      ...
      >
        ...
        {!hideActions && (
          <div className="mt-1 flex w-full justify-center gap-6">
            <button
              className={cn(
                "h-[40px] min-w-[100px] px-5 cursor-pointer rounded-lg border font-ssurround text-md font-bold active:opacity-70",
            ...
            {onConfirm && (
              <button
                className={cn(
                  "h-[40px] min-w-[100px] px-5 cursor-pointer rounded-lg font-ssurround text-md font-bold text-white active:opacity-70",
